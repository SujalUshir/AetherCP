    ...
    extend: {
      ...
      colors: {
        ...
        indigo: {
          ...
          100: "#F5F1EA",
          200: "#EFEAE0",
          300: "hsl(var(--brand-beige))",
          400: "hsl(var(--primary))",
          500: "hsl(var(--primary))",
          600: "hsl(var(--brand-dark))",
          700: "hsl(var(--brand-dark))",
          800: "hsl(var(--brand-dark))",
          900: "hsl(var(--brand-dark))",
        },
        violet: { 400: "hsl(var(--primary))", 500: "hsl(var(--primary))" },
        ...
        fuchsia: { 400: "hsl(var(--primary))", 500: "hsl(var(--primary))" },
